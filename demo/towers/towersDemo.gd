...
var projectile1 = load("res://demo/shared/projectile/Projectile1/projectile1.tscn")
var projectile2 = load("res://demo/shared/projectile/Projectile2/Projectile2.tscn")
